...
module VecCommands =
    ...
    let push4 =
        { new Cmd() with
            ...
            override __.Post(vec, arr) =
                vecEqual vec arr "After pushing four items, vec != arr"
    ...
    let push9 =
        { new Cmd() with
            ...
            override __.Post(vec, arr) =
                vecEqual vec arr "After pushing nine items, vec != arr"
    ...
    let push33 =
        { new Cmd() with
            ...
            override __.Post(vec, arr) =
                vecEqual vec arr "After pushing 33 items, vec != arr"
    ...
    let pop =
        { new Cmd() with
            ...
            override __.Post(vec, arr) =
                vecEqual vec arr "After popping, vec != arr"
    ...
    let insert7InFirstLeaf =
        { new Cmd() with
            ...
            override __.Post(vec, arr) =
                vecEqual vec arr "After inserting 7, vec != arr"
    ...
    let insert9InTail =
        { new Cmd() with
            ...
            override __.Post(vec, arr) =
                vecEqual vec arr "After inserting 9, vec != arr"
    ...
    let removeFromHead =
        { new Cmd() with
            ...
            override __.Post(vec, arr) =
                vecEqual vec arr "After removing from head, vec != arr"

            override __.ToString() = "remove from head"
        }

    let removeFromFirstLeaf =
        { new Cmd() with
            override __.RunActual vec =
                vec
                |> RRBVector.remove 3
            ...
            override __.Post(vec, arr) =
                vecEqual vec arr "After removing at idx 3, vec != arr"
    ...
    let removeFromTail =
        { new Cmd() with
            ...
            override __.Post(vec, arr) =
                vecEqual vec arr "After removing from tail, vec != arr"
