...
// let gitRepoName = "ProjectNameGoesHere"
...
Target.create "DotnetTestOnly" <| fun ctx -> dotnetTest ctx false
Target.create "DotnetTestDebugOnly" <| fun ctx -> dotnetTest ctx true
