...
public abstract class RRBNode<T>
{
    ...
    public abstract SlideResult<RRBNode<T>> InsertedTree(
        OwnerToken owner,
        int shift,
        int treeIdx,
        T item,
    ...
    // TODO: Once unit testing is solid, remove the "shift" parameter from the NeedsRebalance variations, since it should always be Literals.shiftSize
