...
GitHub Actions |
:---: |
[![GitHub Actions](https://github.com/rmunn/Ficus/workflows/Build%20master/badge.svg)](https://github.com/rmunn/Ficus/actions?query=branch%3Amaster) |
[![Build History](https://buildstats.info/github/chart/rmunn/Ficus)](https://github.com/rmunn/Ficus/actions?query=branch%3Amaster) |

## NuGet

Package | Stable | Prerelease
--- | --- | ---
Ficus | [![NuGet Badge](https://buildstats.info/nuget/Ficus)](https://www.nuget.org/packages/Ficus/) | [![NuGet Badge](https://buildstats.info/nuget/Ficus?includePreReleases=true)](https://www.nuget.org/packages/Ficus/)
...
- `DotnetRestore` - Runs [dotnet restore](https://docs.microsoft.com/en-us/dotnet/core/tools/dotnet-restore?tabs=netcore2x) on the [solution file](https://devblogs.microsoft.com/dotnet/introducing-slnx-support-dotnet-cli/).
- [`DotnetBuild`](#Building) - Runs [dotnet build](https://docs.microsoft.com/en-us/dotnet/core/tools/dotnet-build?tabs=netcore2x) on the [solution file](https://devblogs.microsoft.com/dotnet/introducing-slnx-support-dotnet-cli/).
- `FSharpAnalyzers` - Runs [BinaryDefense.FSharp.Analyzers](https://github.com/BinaryDefense/BinaryDefense.FSharp.Analyzers).
- `DotnetTest` - Runs [dotnet test](https://docs.microsoft.com/en-us/dotnet/core/tools/dotnet-test?tabs=netcore21) on the [solution file](https://devblogs.microsoft.com/dotnet/introducing-slnx-support-dotnet-cli/).
...
- The [Github Action](https://github.com/rmunn/Ficus/blob/master/.github/workflows/publish.yml) will handle the new tag:
...
- Set Source for "Build and deployment" on [GitHub Pages](https://github.com/rmunn/Ficus/settings/pages) to `GitHub Actions`.
- Documentation is auto-deployed via [Github Action](https://github.com/rmunn/Ficus/blob/master/.github/workflows/fsdocs-gh-pages.yml) to [Your GitHub Page](https://rmunn.github.io/Ficus/)
